...
public class CMSFeatureFlags {
    ...
    public static final String ENABLE_INTERATIVES_PUBLISHING = "ENABLE_INTERATIVES_PUBLISHING";
    ...
    private CMSFeatureFlags() {
        ...
        this.isInteractivesPublishingEnabled = Boolean.valueOf(getConfigValue(ENABLE_INTERATIVES_PUBLISHING));
        ...
        info().data(ENABLE_DATASET_IMPORT, isDatasetImportEnabled)
                ...
                .data(ENABLE_INTERATIVES_PUBLISHING, isInteractivesPublishingEnabled)
